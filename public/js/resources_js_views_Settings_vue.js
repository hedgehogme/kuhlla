...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    staticClass: "col-3"
  }, [_c("h6", [_vm._v(_vm._s(_vm.__("mobile")))])])]), _vm._v(" "), _vm._l(_vm.statuses, function (status, index) {
    return _c("div", {
      staticClass: "row d-flex justify-content-between"
    }, [_c("div", {
      staticClass: "col-6"
      ...
      staticClass: "form-check form-switch col-3"
    }, [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
      ...
      domProps: _defineProperty({
        value: status.id,
        checked: _vm.mobile_statuses.includes(status.id)
      }, "checked", Array.isArray(_vm.mobile_statuses) ? _vm._i(_vm.mobile_statuses, status.id) > -1 : _vm.mobile_statuses),
      on: {
        change: function change($event) {
          ...
          if (Array.isArray($$a)) {
            var $$v = status.id,
              $$i = _vm._i($$a, $$v);
            if ($$el.checked) {
              $$i < 0 && (_vm.mobile_statuses = $$a.concat([$$v]));
            } else {
              $$i > -1 && (_vm.mobile_statuses = $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
            }
          } else {
