                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="color">{{ __('color_picker') }}</label>
                                    <i class="text-danger">*</i>
                                    <input type="color" id="color" name='color' v-model="settings.color" class="form-control">
<!--                                    <div class="mt-2">
                                        <input class='form-check-input' id="show_color_picker_in_website" type='checkbox'
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="row" v-if="web_logo_url">
                                        <div class="col-md-2">
                                            <img class="custom-image" :src="web_logo_url" title='Web Logo' alt='Web Logo'/>
                                        </div>
                                    </div>
...
<!--                                    <input type='file' name='favicon' id='favicon' v-on:change="handleFaviconUpload" ref="favicon" accept="image/*" class="form-control" />
                                    <div class="row" v-if="settings.favicon">
                                        ...
                                        <div class="col-md-6">
                                            <img :src="$storageUrl + settings.favicon" :title="__('favicon_icon')" alt='Favicon Icon' style="max-width:100%" />
                                        </div>
                                    </div>-->
                                    ...
                                    <div class="row" v-if="favicon_url">
                                        <div class="col-md-2">
                                            <img class="custom-image" :src="favicon_url" title='Web Logo' alt='Web Logo'/>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4" v-if="settings.is_android_app == 1">
...
<!--                                        <input type='file' name='play_store_logo' id='play_store_logo' v-on:change="handlePlayStoreLogoUpload" ref="play_store_logo" accept="image/*" class="form-control" />
                                        <div class="row" v-if="settings.play_store_logo">
                                            <div class="col-md-6">
                                                <img :src="$storageUrl + settings.play_store_logo" title='Favicon Icon' alt='Favicon Icon' style="max-width:100%" />
                                            </div>
                                        </div>-->
                                        ...
                                        <div class="row" v-if="play_store_logo_url">
                                            <div class="col-md-2">
                                                <img class="custom-image" :src="play_store_logo_url" title='Web Logo' alt='Web Logo'/>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4" v-if="settings.is_ios_app == 1">
...
<!--                                        <input type='file' name='ios_store_logo' id='ios_store_logo' v-on:change="handleIosStoreLogoUpload" ref="ios_store_logo" accept="image/*" class="form-control" />
                                        <div class="row" v-if="settings.ios_store_logo">
                                            <div class="col-md-6">
                                                <img :src="$storageUrl + settings.ios_store_logo" title='Ios store logo' alt='Ios store logo' style="max-width:100%" />
                                            </div>
                                        </div>-->
                                        ...
                                        <div class="row" v-if="ios_store_logo_url">
                                            <div class="col-md-2">
                                                <img class="custom-image" :src="ios_store_logo_url" title='IOS store Logo' alt='IOS store Logo'/>
                                            </div>
                                        </div>
