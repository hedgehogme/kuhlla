                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" ref="file_image" v-on:change="fileImage" class="file-input">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="other_images[]" id="other_images" v-on:change="otherImage" multiple="" ref="file_other_images" class="file-input">
...
<!--                                                <select class="form-control form-select" @change="changeUnits()" v-model="input.packet_stock_unit_id = inputs[0].packet_stock_unit_id">-->
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="form-group">
                                                ...
                                                <input type="file" :ref="'packet_variant_images_'+k " multiple class="file-input"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group loose_div">
                                                    <label>{{ __('variant_images') }}</label>
<!--                                                @drop="dropFileStoreLogo"               -->
                                                    <input type="file" :ref="'loose_variant_images_'+k " multiple  class="file-input" v-on:change="variantImagesChanges(k)" @dragover="$dragoverFile" @dragleave="$dragleaveFile">
