...
<!--                    <input type="file" name="category_image" v-on:change="handleFileUpload" ref="file_image" required v-if="!id" class="file-input">
...
<!--                    <input type="file" name="category_image" v-on:change="handleFileUpload" ref="file_image" :required="!id" class="file-input">-->
                    ...
                    <input type="file" name="category_image" v-on:change="handleFileUpload" ref="file_image" class="file-input">
