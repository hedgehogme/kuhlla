    ...
    <form ref="my-form" @submit.prevent="saveRecord">
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="number" class="form-control" v-model="no_of_users" placeholder="Enter no. of users" />
        </div>
        <div class="form-group col-md-6">
          <label>Minimum Order Amount <i class="text-danger">*</i></label>
          <input type="number" class="form-control" v-model="minimum_order_amount" placeholder="Enter minimum order amount." />
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6" v-if="discount_type != '' ">
              ...
              <input type="number" required class="form-control" v-if="discount_type == 'amount'" v-model="discount" placeholder="Enter discount amount." />
          </div>
        ...
        <div class="form-group col-md-6" v-if="repeat_usage === 1 || repeat_usage === '1'">
          ...
          <div class="form-group">
              ...
              <input type="file" name="image" v-on:change="handleFileUpload" ref="file_image" class="file-input">
